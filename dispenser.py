...
class Dispenser:
    ...
    def test(self, pump_name):
        ...
        self.event_scheduler.schedule(3.5, lambda: self.set_speed(pump_name, 0.7))
        self.event_scheduler.schedule(4, lambda: self.set_speed(pump_name, 0.8))
        ...
        self.event_scheduler.schedule(10.5, lambda: self.set_speed(pump_name, 0.7))
        self.event_scheduler.schedule(11, lambda: self.set_speed(pump_name, 0.8))
        self.event_scheduler.schedule(11.5, lambda: self.set_speed(pump_name, 0.9))
        self.event_scheduler.schedule(12, lambda: self.set_speed(pump_name, 1))
