...
class MainLoop:
    ...
    def page_admin(self):
        self.set_buttons([
            Button(self.screen, pygame.Rect(50, 20, 570, 70), 'RESTART', (50, 255, 50), self.page_start),
            Button(self.screen, pygame.Rect(50, 110, 570, 70), 'DRINKS SCREEN', (50, 50, 255), self.show_drink_buttons),
            Button(self.screen, pygame.Rect(50, 200, 570, 70), 'TEST CYAN', (0, 255, 255), lambda: self.dispenser.test('cyan')),
